...
python train_cls.py   configs/transfer.yaml --run_dir runs-512/syn/mbv2-w0.35/sparse_100kb/sgd_qas_nomom \
    --net_name mbv2-w0.35  --bs256_lr  0.1  --optimizer_name sgd_scale_nomom \
    --enable_backward_config 1 --n_bias_update 25 --manual_weight_idx 27-30-33-36-39-42-45-48 \
    --weight_update_ratio 1-1-1-1-1-0.125-0.5-1 > train_sparse_update3.txt 2>&1
